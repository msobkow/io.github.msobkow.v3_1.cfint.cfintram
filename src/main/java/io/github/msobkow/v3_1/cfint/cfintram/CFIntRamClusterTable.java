	...
	implements ICFIntClusterTable
{
	...
	public ICFSecCluster lockDerived( ICFSecAuthorization Authorization,
		Long PKey )
	{
		final String S_ProcName = "CFIntRamCluster.lockDerived";
		ICFSecCluster buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFSecCluster readRec( ICFSecAuthorization Authorization,
		Long PKey )
	{
		final String S_ProcName = "CFIntRamCluster.readRec";
	...
	{
		final String S_ProcName = "CFIntRamCluster.readAllRec";
		ICFSecCluster buff;
	...
	public ICFSecCluster readRecByIdIdx( ICFSecAuthorization Authorization,
		long Id )
	{
		final String S_ProcName = "CFIntRamCluster.readRecByIdIdx() ";
	...
	public ICFSecCluster readRecByUDomNameIdx( ICFSecAuthorization Authorization,
		String FullDomName )
	{
		final String S_ProcName = "CFIntRamCluster.readRecByUDomNameIdx() ";
	...
	public ICFSecCluster readRecByUDescrIdx( ICFSecAuthorization Authorization,
		String Description )
	{
		final String S_ProcName = "CFIntRamCluster.readRecByUDescrIdx() ";
